...
for epoch in range(epochs):
    ...
    if loss_val_avg < best_val_loss:
        ...
        torch.save(pn_cls, "best_model_cardio_biosample_id.pt")
        patience_counter = 0
...
pn_cls_checkpoint = torch.load("best_model_cardio_biosample_id.pt")
...
plt.show()
fig.savefig("pred_label_val_cardio_biosample_id.png")
fig = plt.figure(figsize=(10, 10))
sns.heatmap(true_label_val_df, cmap="coolwarm", cbar=True)
plt.show()
fig.savefig("true_label_val_cardio_biosample_id.png")
...
plt.show()
fig.savefig("pred_label_tr_cardio_biosample_id.png")
fig = plt.figure(figsize=(10, 10))
sns.heatmap(true_label_tr_df, cmap="coolwarm", cbar=True)
plt.show()
fig.savefig("true_label_tr_cardio_biosample_id.png")
...
# biosample_id
#  auROC_tr 1.0
#  auROC_val 0.9650793650793651
#  macroF1_tr 1.0
#  macroF1_val 0.8632478632478633