...
true_label_val_df = true_label_val_df.sort_values(by=["WHITE"], ascending=False)
...
true_label_tr_df = true_label_tr_df.sort_values(by=["WHITE"], ascending=False)
...
print(auROC_tr, auROC_val, macroF1_tr, macroF1_val)
# disease_cov
# 1.0 1.0 1.0 1.0

# race
# 0.9995210727969348 0.8771929824561404 0.9839819648789748 0.8178571428571428
# 1.0, 0.88, 0.98, 0.82