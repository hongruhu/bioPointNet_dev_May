...
for epoch in range(epochs):
    ...
    if loss_val_avg < best_val_loss:
        ...
        torch.save(enc, "best_enc_covid.pt")
        patience_counter = 0
...
enc_checkpoint = torch.load("best_enc_covid.pt")
...
# donor_id
#  auROC_tr 1.0
#  auROC_val 0.888888888888889
#  macroF1_tr 0.9520833333333334
#  macroF1_val 0.6571428571428571