...
for epoch in range(epochs):
    ...
    if loss_val_avg < best_val_loss:
        ...
        torch.save(pn_cls, "best_model_cardio.pt")
        torch.save(enc, "best_enc_cardio.pt")
        patience_counter = 0
...
pn_cls_checkpoint = torch.load("best_model_cardio.pt")
enc_checkpoint = torch.load("best_enc_cardio.pt")
...
plt.show()
fig.savefig("pred_label_val_cardio.png")
fig = plt.figure(figsize=(10, 10))
sns.heatmap(true_label_val_df, cmap="coolwarm", cbar=True)
plt.show()
fig.savefig("true_label_val_cardio.png")
...
plt.show()
fig.savefig("pred_label_tr_cardio.png")
fig = plt.figure(figsize=(10, 10))
sns.heatmap(true_label_tr_df, cmap="coolwarm", cbar=True)
plt.show()
fig.savefig("true_label_tr_cardio.png")
