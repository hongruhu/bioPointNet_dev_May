...
Ys_df = pd.get_dummies(adata.obs['pop_cov'].copy()).astype(int)
...
for epoch in range(epochs):
    ...
    if loss_val_avg < best_val_loss:
        ...
        torch.save(pn_cls, "best_model_lupus_pop_cov.pt")
        torch.save(enc, "best_enc_lupus_pop_cov.pt")
        patience_counter = 0
...
pn_cls_checkpoint = torch.load("best_model_lupus_pop_cov.pt")
enc_checkpoint = torch.load("best_enc_lupus_pop_cov.pt")
...
true_label_val_df = true_label_val_df.sort_values(by=["ASIAN"], ascending=False)
...
plt.show()
fig.savefig("pred_label_val_lupus_pop_cov.png")
fig = plt.figure(figsize=(10, 10))
sns.heatmap(true_label_val_df, cmap="coolwarm", cbar=True)
plt.show()
fig.savefig("true_label_val_lupus_pop_cov.png")
...
#  auROC_val 1.0
#  macroF1_tr 1.0
#  macroF1_val 0.9328063241106719


# ind_cov [race]
#  auROC_tr 0.9683908045977012
#  auROC_val 0.8982456140350878
#  macroF1_tr 0.8611111111111112
...
# ind_cov  [pop_cov]
#  auROC_tr 0.9827586206896552
#  auROC_val 0.9228070175438596
#  macroF1_tr 0.9441786283891547
#  macroF1_val 0.8823529411764706
