...
for SEED in range(10):
    for fold in [1,2,3,4,5]:
        ...
        auROC_val = np.mean([
            roc_auc_score(true_label_val_df[c], pred_label_val_df[c])
            for c in true_label_val_df.columns
            if len(np.unique(true_label_val_df[c])) > 1
        ])
        ...
        auROC_test = np.mean([
            roc_auc_score(true_label_test_df[c], pred_label_test_df[c])
            for c in true_label_test_df.columns
            if len(np.unique(true_label_test_df[c])) > 1
        ])
...
res_test_df.mean()
# auROC_test      0.879593
# macroF1_test    0.668365

# auROC_test      0.984889
# macroF1_test    0.907499
...
# 0
# auROC_test      0.856349
# macroF1_test    0.673175
# dtype: object


# 1
# auROC_test      0.889788
# macroF1_test    0.691429
# dtype: object


# 2
# auROC_test      0.908889
# macroF1_test     0.69873
# dtype: object


# 3
# auROC_test      0.876349
# macroF1_test    0.590476
# dtype: object


# 4
# auROC_test      0.885661
# macroF1_test    0.727143
# dtype: object


# 5
# auROC_test      0.860317
# macroF1_test     0.68746
# dtype: object


# 6
# auROC_test      0.911534
# macroF1_test    0.678571
# dtype: object


# 7
# auROC_test      0.887249
# macroF1_test    0.676508
# dtype: object


# 8
# auROC_test      0.822751
# macroF1_test    0.561429
# dtype: object
...
# 0
# auROC_test           1.0
# macroF1_test    0.944944
# dtype: object


# 1
# auROC_test       0.9925
# macroF1_test    0.95757
# dtype: object


# 2
# auROC_test      0.981111
# macroF1_test    0.825897
# dtype: object


# 3
# auROC_test        0.9925
# macroF1_test    0.958681
# dtype: object


# 4
# auROC_test      0.981389
# macroF1_test    0.900269
# dtype: object


# 5
# auROC_test         0.985
# macroF1_test    0.898962
# dtype: object


# 6
# auROC_test           1.0
# macroF1_test    0.985348
# dtype: object


# 7
# auROC_test      0.994167
# macroF1_test    0.893052
# dtype: object


# 8
# auROC_test      0.965278
# macroF1_test    0.903895
# dtype: object


# 9
# auROC_test      0.956944
# macroF1_test    0.806373
# dtype: object
...
# auROC_test      0.959259
# macroF1_test    0.812619
# dtype: object


# auROC_test      0.870926
# macroF1_test    0.593492
# dtype: object


# auROC_test      0.769444
# macroF1_test    0.481508
# dtype: object


# auROC_test      0.865556
# macroF1_test     0.69627
# dtype: object


# auROC_test      0.932778
# macroF1_test    0.757937
# dtype: object



# auROC_test      0.990694
# macroF1_test    0.958583
# dtype: object


# auROC_test      0.989861
# macroF1_test    0.888431
# dtype: object
