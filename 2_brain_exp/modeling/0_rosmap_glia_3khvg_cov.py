...
adata = sc.read_h5ad(path + 'ROSMAP_glia_processed_.h5ad')
...
# View of AnnData object with n_obs × n_vars = 930739 × 3000
...
adata.obs.subject.value_counts() # 349
...
# Number of bags: 349 Number of labels: (349, 2) Number of max instances: 10252
...
for epoch in range(epochs):
    ...
    if loss_val_avg < best_val_loss:
        ...
        torch.save(pn_cls, "best_model_ROSMAP.pt")
        torch.save(enc, "best_enc_ROSMAP.pt")
        patience_counter = 0
...
pn_cls_checkpoint = torch.load("best_model_ROSMAP.pt")
enc_checkpoint = torch.load("best_enc_ROSMAP.pt")
...
loss_val/len(val_lengths) # 0.6038 | 0.6843
...
true_label_val_df = true_label_val_df.sort_values(by=["yes"], ascending=False)
...
plt.show()
fig.savefig("pred_label_val_ROSMAP.png")
fig = plt.figure(figsize=(10, 10))
sns.heatmap(true_label_val_df, cmap="coolwarm", cbar=True)
plt.show()
fig.savefig("true_label_val_ROSMAP.png")
...
# subject
#  auROC_tr 0.9920624542316141
#  auROC_val 0.7203947368421053
#  macroF1_tr 0.9817027583583636
#  macroF1_val 0.6949574600539531

# subject
#  auROC_tr 0.8498796945287164
#  auROC_val 0.5797697368421053
#  macroF1_tr 0.7633085896076353
#  macroF1_val 0.5779500430663221
...
metadata_tr.sort_values(by='attention_score_norm_cellnum',ascending=False)[0:1000].cell_type_high_resolution.value_counts()
