...
adata = sc.read_h5ad(path + 'DLPFC_glial.h5ad')
...
# View of AnnData object with n_obs × n_vars = 312401 × 3000
...
adata.obs.donor_id.value_counts() # 83
...
# Number of bags: 83 Number of labels: (83, 2) Number of max instances: 9795
...
for epoch in range(epochs):
    ...
    if loss_val_avg < best_val_loss:
        ...
        torch.save(pn_cls, "best_model_seaadDLPFC.pt")
        torch.save(enc, "best_enc_seaadDLPFC.pt")
        patience_counter = 0
...
pn_cls_checkpoint = torch.load("best_model_seaadDLPFC.pt")
enc_checkpoint = torch.load("best_enc_seaadDLPFC.pt")
...
plt.show()
fig.savefig("pred_label_val_seaadDLPFC.png")
fig = plt.figure(figsize=(10, 10))
sns.heatmap(true_label_val_df, cmap="coolwarm", cbar=True)
plt.show()
fig.savefig("true_label_val_seaadDLPFC.png")
...
plt.show()
fig.savefig("pred_label_tr_seaadDLPFC.png")
fig = plt.figure(figsize=(10, 10))
sns.heatmap(true_label_tr_df, cmap="coolwarm", cbar=True)
plt.show()
fig.savefig("true_label_tr_seaadDLPFC.png")
...
# donor_id
#  auROC_tr 0.9981566820276497
#  auROC_val 0.9305555555555556
#  macroF1_tr 0.9542830755021934
#  macroF1_val 0.8235294117647058

# donor_id
#  auROC_tr 0.9990783410138249
#  auROC_val 0.75
#  macroF1_tr 0.9694444444444444
#  macroF1_val 0.7638888888888888

len(attention_mtx_list)     # 
len(instance_level_list)    # 
...
# cell_type
# oligodendrocyte precursor cell      685
# microglial cell                     300
# oligodendrocyte                       5
# cerebral cortex endothelial cell      5
# vascular leptomeningeal cell          4
# astrocyte of the cerebral cortex      1

# cell_type
# astrocyte of the cerebral cortex    843
# vascular leptomeningeal cell        110
# microglial cell                      35
# cerebral cortex endothelial cell      9
# oligodendrocyte                       3
...
# OPC_2_2-SEAAD           55
# Micro-PVM_1             43
# Micro-PVM_3-SEAAD       22
# Micro-PVM_2_2-SEAAD     11
# Endo_2                   5
# VLMC_2                   4
