...
# sc.pp.highly_variable_genes(adata, n_top_genes=5600, flavor='cell_ranger')
# adata = adata[:,adata.var.highly_variable==True]


# all glial types
metadata_all = pd.read_csv(path + data_source + '_glia_metadata.csv', index_col=0)
adata = adata[metadata_all.index.tolist()]
...
for SEED in range(5):
    ...
    adata_tr.obsm['X_emb'] = adata_tr.obsm['X_sciMultiLaMA']
