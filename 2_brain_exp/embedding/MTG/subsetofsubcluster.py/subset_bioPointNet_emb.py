...
path = '/group/gquongrp/workspaces/hongruhu/bioPointNet/Micro3/'



# all glial types
metadata_all = pd.read_csv(path + data_source + '_glia_metadata.csv', index_col=0)
cell_mtx = pd.read_csv(path + data_source + '_sciMultiLaMA_CELL_embedding.csv', index_col=0)
...
# Number of bags: 86 Number of labels: (86, 2) Number of max instances: 157
