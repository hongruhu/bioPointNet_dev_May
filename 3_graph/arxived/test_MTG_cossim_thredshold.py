...
df_edges, entity_alias, graph_stats = gen_graph_cosine(
    cell_emb=cell_emb.values,
    gene_emb=gene_emb.values,
    cell_ids=cell_emb.index,
    gene_ids=gene_emb.index,
    dirname=dirname,  # or 'graph_CGC' if you include all
    sim_threshold=0.2,
    cc_threshold=0.3,
    gg_threshold=0.3,
...
plt.savefig('cell_umap_cossim.png')
...
si.pl.umap(adata_all,color=['id_dataset','entity_anno'],
           ...
           fig_size=(6,5))
plt.savefig('cell_gene_umap_cossim.png')
